#include "AllSi_vtx_serv_2lyr_DisplayAction.h"
...
AllSi_vtx_serv_2lyr_DisplayAction::AllSi_vtx_serv_2lyr_DisplayAction(const std::string &name)
  : PHG4DisplayAction(name)
  , m_MyVolume(nullptr)
{
}

AllSi_vtx_serv_2lyr_DisplayAction::~AllSi_vtx_serv_2lyr_DisplayAction()
{
...
void AllSi_vtx_serv_2lyr_DisplayAction::ApplyDisplayAction(G4VPhysicalVolume *physvol)
{
